...
const Typing = () => {
  return (
    <div className="flex justify-center items-center animate-[wiggle_5s_ease-in-out_infinite]">
      <svg height="40" width="40" className="loader">
        ...
        <circle className="dot2 fill-yellow-400" cx="20" cy="15" r="2" />
        <circle className="dot2 fill-yellow-400" cx="20" cy="25" r="2" />

        <circle className="dot3 fill-yellow-400" cx="30" cy="20" r="1.5" />
      </svg>
    </div>
  );
};
